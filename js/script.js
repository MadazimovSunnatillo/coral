...
let productPremium = document.querySelector(
  "section#premium #premium-products"
);
let productNew = document.querySelector("section#new-product #new-products");
...
product.forEach((product) => {
  ...
  if (price > 60 && price < 700) {
    productNew.innerHTML += box;
  }
  if (price < 11) {
    productBest.innerHTML += box;
  }
  if (price > 113) {
    productPremium.innerHTML += box;
  }
});
